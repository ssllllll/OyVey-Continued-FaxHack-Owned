...
class GLUProjection {
    ...
    public
    void updateMatrices(IntBuffer viewport, FloatBuffer modelview, FloatBuffer projection, double widthScale, double heightScale) {
        float fov;
    ...
    public
    boolean[] doFrustumCheck(Vector3D[] frustumCorners, Vector3D frustumPos, double x, double y, double z) {
    ...
    public
    boolean crossPlane(Vector3D[] plane, Vector3D point) {
    ...
    public
    Vector3D[] getFrustum(double x, double y, double z, double rotationYaw, double rotationPitch, double fov, double farDistance, double aspectRatio) {
    ...
    public
    Vector3D getRotationVector(double rotYaw, double rotPitch) {
    ...
    class Vector3D {
        ...
        public
        Vector3D sadd(double x, double y, double z) {
            this.x += x;
            this.y += y;
            this.z += z;
            return this;
        ...
        public
        Vector3D ssub(double x, double y, double z) {
            this.x -= x;
            this.y -= y;
            this.z -= z;
            return this;
        ...
        public
        void setTitle(String defaultValue) {
        }
    }
    ...
    class Line {
        ...
        private
        Vector3D intersectXZ(Line line) {
            double a = this.sourcePoint.x;
            double b = this.direction.x;
            double c = line.sourcePoint.x;
            double d = line.direction.x;
        ...
        private
        Vector3D intersectYZ(Line line) {
        ...
        public
        Vector3D intersectPlane(Vector3D pointOnPlane, Vector3D planeNormal) {
