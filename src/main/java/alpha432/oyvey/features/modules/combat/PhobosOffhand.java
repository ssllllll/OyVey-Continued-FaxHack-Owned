...
import alpha432.oyvey.features.modules.client.ServerModule;
import alpha432.oyvey.OyVey;
import alpha432.oyvey.api.events.PacketEvent;
import alpha432.oyvey.api.events.ProcessRightClickBlockEvent;
import alpha432.oyvey.features.setting.Bind;
import alpha432.oyvey.features.setting.EnumConverter;
import alpha432.oyvey.features.setting.Setting;
import alpha432.oyvey.mixin.mixins.accessors.IContainer;
import alpha432.oyvey.mixin.mixins.accessors.ISPacketSetSlot;
import alpha432.oyvey.api.util.EntityUtil;
...
public class PhobosOffhand
    ...
    private static PhobosOffhand instance;
    ...
    public static PhobosOffhand getInstance() {
        if (instance == null) {
            instance = new PhobosOffhand();
        }
        return instance;
    }

    public void onItemFinish(ItemStack stack, EntityLivingBase base) {
        if (this.noOffhandGC.getValue().booleanValue() && base.equals((Object)PhobosOffhand.mc.player) && stack.getItem() == Offhand.mc.player.getHeldItemOffhand().getItem()) {
